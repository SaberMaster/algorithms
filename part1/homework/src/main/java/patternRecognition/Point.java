        ...
        return new Comparator<Point>() {
            public int compare(Point p1, Point p2) {
                ...
                if (Math.abs(slope1 - slope2) < 0.0000001 ||
                    (Double.POSITIVE_INFINITY == slope1
                     && Double.POSITIVE_INFINITY == slope2) ||
                    (Double.NEGATIVE_INFINITY == slope1
                     && Double.NEGATIVE_INFINITY == slope2)) return 0;
